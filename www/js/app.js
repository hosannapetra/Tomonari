...
app.controller('homeCtrl',function($scope,$state,$ionicPopup,$ionicViewService,$timeout,$ionicLoading,$interval,userService,userScheduleService,removeBookingService,waitlistService,removeWaitlistService,historyService,purchaseHistoryService,$ionicModal,feedbackDb,$firebase,removeAppointmentService){
	...
	upcoming.style.cssText ="background-color:#67657f; color:#ffffff;";
	...
	$scope.showUpcoming = function(){
		...
		upcoming.style.cssText="background-color:#f8f8f8;color:#67657f; border-bottom: thick solid #67657f;border-bottom-width:2px;";
		history.style.cssText ="background-color:#f8f8f8";
	};	
	...
	$scope.showHistory = function(){
		...
		history.style.cssText ="background-color:#f8f8f8;color:#67657f; border-bottom: thick solid #67657f;border-bottom-width:2px;";
